...
# taken from https://github.com/sniklaus/pytorch-liteflownet
...
def FunctionCorrelation(tenFirst, tenSecond, stride):
    return _FunctionCorrelation.apply(tenFirst, tenSecond, stride)
