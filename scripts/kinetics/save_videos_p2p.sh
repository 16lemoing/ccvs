...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} helpers/generator.py \
 --name save_videos_p2p_kinetics600 \
 --x_which_iter "latest" --x_load_path "checkpoints/2021-05-22-23:32:03-transformer_p2p_kinetics600" \
 --vid_len 16 --vid_skip 30 --x_cond_len 64 --batch_size_vid 16 --batch_size_valid_mult 1 --num_workers 8 --n_iter 78 \
 ...
 --q_which_iter "latest" --q_load_path "checkpoints/2021-05-20-21:33:55-frame_autencoder_p2p_kinetics600" \
