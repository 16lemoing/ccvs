...
CUDA_VISIBLE_DEVICES=${GPU_IDS} python -m torch.distributed.launch --nproc_per_node=${NUM_GPUS} helpers/transformer_trainer.py \
 --name transformer_kinetics600 \
 --dataset "kinetics600" --max_dim 64 --is_seq --log_fps 1 --vid_len 16 \
 ...
 --n_iter 800000 --batch_size_vid 16 \
 --q_d_reg_every 16 \
 ...
 --x_z_num 16384 --x_z_len 1024 --x_cond_len 256 --x_n_layer 24 --x_n_head 16 --x_n_embd 1024 --x_lr 0.00001 --x_sample --x_top_k 100 \
